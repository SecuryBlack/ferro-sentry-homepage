...
const footerLinks = {
  Product: [
    ...
    { label: "Roadmap",   href: "https://github.com/securyblack/ferro-sentry/issues", external: true },
  ],
  Docs: [
  ...
  Community: [
    { label: "GitHub",  href: "https://github.com/securyblack/ferro-sentry", external: true },
    { label: "Issues",  href: "https://github.com/securyblack/ferro-sentry/issues", external: true },
    { label: "License", href: "https://github.com/securyblack/ferro-sentry/blob/main/LICENSE", external: true },
  ],
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-[var(--color-muted)] leading-relaxed mb-4">
              Ultralight EDR, posture auditor, and security agent written in Rust.
            </p>
            <a
        ...
        <div className="mt-12 pt-8 border-t border-[var(--color-border)] flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-[var(--color-muted)]">
            © {new Date().getFullYear()} Ferro Sentry. Licensed under Apache 2.0 / MIT.
          </p>
          <a
            href="https://securyblack.com"
            target="_blank"
