...
const INSTALL_CMD = `curl -fsSL https://install.ferrosentry.dev | sudo bash`;
  ...
  return (
    <section className="relative min-h-[92vh] flex flex-col items-center justify-center px-4 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center flex flex-col items-center gap-4 sm:gap-6">
        ...
        >
          Active server defense.{" "}
          <span className="text-gradient-primary">Continuous posture audits.</span>
        </motion.h1>
        ...
        >
          Ferro Sentry is an ultralight security and EDR agent written in{" "}
          <span className="text-[var(--color-text)]">Rust</span>. Continuous SSH, port, FIM, and process auditing with{" "}
          <span className="text-[var(--color-text)]">near-zero overhead</span> and native gRPC streaming.
        </motion.p>
