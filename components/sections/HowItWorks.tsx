...
import { Server, ArrowRight, Shield, Cpu, LayoutDashboard, Cloud, Share2 } from "lucide-react";
    ...
    <section className="py-16 md:py-24 px-4 border-y border-[var(--color-border)] bg-[var(--color-surface)]/40">
      <div className="max-w-7xl mx-auto">
        ...
        >
          {mode === "securyblack" ? (
            <>
              ...
              />
              <Connector label="Audit Events" />
              <FlowNode
                icon={Shield}
                label="Ferro Sentry"
                description="EDR & Auditing (Rust)"
              ...
              <FlowNode
                ...
                description="Security Posture Dashboard"
                iconColor="var(--color-muted)"
              />
            </>
          ) : (
        ...
        >
          {[
            {
              label: "Zero Bottlenecks",
              detail: "Deduplication & rate-limiting prevent security log floods",
            },
            {
              label: "Offline Resilience",
              detail: "Buffers security findings locally on disk if collectors drop",
            },
            {
              label: "Unified Telemetry",
              detail: "Multiplexed alongside OxiPulse metrics over local gRPC",
            },
          ].map((item) => (
